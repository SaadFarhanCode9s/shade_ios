...
final class BuildSettings: NSObject {
    ...
    static let applicationWebAppUrlString = "https://matrix.shadeapp.dev"
    ...
    static var serverConfigDefaultHomeserverUrlString: String {
        "https://matrix.shadeapp.dev"
    }
    
    /// Default identity server
    static let serverConfigDefaultIdentityServerUrlString = "https://matrix.shadeapp.dev"
...
//        "www.example.com": ["/"],
    ...
    struct ReplacementApp {
        ...
        let learnMoreURL = URL(string: "https://matrix.shadeapp.dev")!
        ...
        let appStoreURL = URL(string: "https://matrix.shadeapp.dev")!
    }
